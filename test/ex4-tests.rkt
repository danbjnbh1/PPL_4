...
;; Addition tests
(check-equal? (equal-trees$ '(1 (2) ((4 5))) '(1 (#t) ((4 5))) id id) '((1 . 1) ((2 . #t)) (((4 . 4) (5 . 5)))) "incorrect equal-trees$ 5")
(check-equal? (equal-trees$ '(1 2 3) '() id id) (cons '(1 2 3) '()) "incorrect equal-trees$ 6")
(check-equal? (equal-trees$  '(1 (2 3)) '(1 (2)) id id) (cons '(3) '()) "incorrect equal-trees$ 7")
(check-equal? (equal-trees$ '(1 (2 3)) '(4 5 6) id id) (cons '(2 3) 5) "incorrect equal-trees$ 8")
(check-equal? (equal-trees$ '() '(1) id id) (cons '() '(1)) "incorrect equal-trees$ 9")
